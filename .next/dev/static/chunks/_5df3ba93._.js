...
"[project]/app/tools/claude-md-builder/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SECTIONS = [
        ...
        options: [
            {
                id: "npm",
                label: "npm",
                snippet: "# Package manager: npm\n# Install: npm install\n# Run scripts: npm run <script>"
            },
            {
                id: "pnpm",
                label: "pnpm",
                snippet: "# Package manager: pnpm (not npm)\n# Install: pnpm install\n# Run scripts: pnpm <script>"
            },
            {
                id: "yarn",
                label: "yarn",
                snippet: "# Package manager: yarn\n# Install: yarn install\n# Run scripts: yarn <script>"
            },
            {
                id: "bun",
                label: "bun",
                snippet: "# Package manager: bun (not npm)\n# Install: bun install\n# Run scripts: bun run <script>"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        options: [
            {
                id: "esm",
                label: "ES Modules only",
                snippet: "# Code style\n- Use ES modules (import/export), never CommonJS (require)\n- Destructure imports: import { foo } from 'bar'"
            },
            {
                id: "single-quotes",
                label: "Single quotes",
                snippet: "- Single quotes for strings, no semicolons"
            },
            {
                id: "2-spaces",
                label: "2-space indent",
                snippet: "- 2-space indentation"
            },
            {
                id: "async-await",
                label: "async/await over callbacks",
                snippet: "- Prefer async/await over callbacks and .then() chains"
            },
            {
                id: "no-throw",
                label: "Result pattern (no throw)",
                snippet: "- Use Result<T,E> pattern for error handling, never throw\n- All errors should be explicit return values"
            }
        ]
    },
    {
        ...
        options: [
            ...
            {
                id: "squash",
                label: "Squash before merge",
                snippet: "- Squash commits before merging to main\n- PR description must include test plan"
            },
            {
                id: "no-force",
                label: "No force push to main",
                snippet: "- Never force push to main or master\n- Prefer rebasing feature branches"
            }
        ]
    },
    {
        ...
        options: [
            {
                id: "handlers",
                label: "API handlers in src/api/",
                snippet: "# Architecture\n- API handlers live in src/api/handlers/ only\n- Never put business logic in route handlers"
            },
            {
                id: "db-queries",
                label: "DB queries in src/db/",
                snippet: "- All database queries go through src/db/queries/ only\n- Never write raw SQL outside of that directory"
            },
            {
                id: "components",
                label: "React components in src/components/",
                snippet: "- React components in src/components/\n- Each component in its own directory with an index.ts export"
            },
            {
                id: "microservices",
                label: "Service boundaries",
                snippet: "- Each service communicates only through its public API\n- No direct database access across service boundaries"
            }
        ]
    },
    {
        ...
        options: [
            {
                id: "no-env",
                label: "Never commit .env",
                snippet: "\n# Important\n- NEVER commit .env files or any file containing secrets"
            },
            {
                id: "lint-before",
                label: "Lint before commit",
                snippet: "- Always run lint before committing: npm run lint"
            },
            {
                id: "single-test",
                label: "Run single test not full suite",
                snippet: "- Prefer running single tests over the full suite for speed"
            },
            {
                id: "migration",
                label: "No edits to migration files",
                snippet: "- NEVER edit existing migration files — create new ones instead"
            }
        ]
    }
];
function Checkbox({ checked, onChange }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        children: checked && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__["Check"], {
            ...
            fileName: "[project]/app/tools/claude-md-builder/page.tsx",
            lineNumber: 93,
            columnNumber: 19
        }, this)
    }, void 0, false, {
...
function ClaudeMdBuilderPage() {
    ...
    const [projectName, setProjectName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("my-project");
    const [customNote, setCustomNote] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const toggle = (id)=>{
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AnimatedSection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatedSection"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Pick what applies to your project → get a ready-to-use CLAUDE.md"
                            }, void 0, false, {
                                fileName: "[project]/app/tools/claude-md-builder/page.tsx",
                                lineNumber: 139,
                                columnNumber: 11
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    SECTIONS.map((section, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AnimatedSection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatedSection"], {
                                            delay: i * 40,
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "rounded-xl p-5",
                                                style: {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "space-y-2",
                                                        children: section.options.map((opt)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "text-sm transition-colors group-hover:text-purple-300",
                                                                        style: {
                                                                            color: selected.has(opt.id) ? "#c4b5fd" : "#94a3b8"
                                                                        },
                                                                        children: opt.label
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/tools/claude-md-builder/page.tsx",
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "text-xs px-1.5 py-0.5 rounded-full badge-purple",
                                                                    children: [
                                                                        output.split("\n").length,
                                                                        " lines"
                                                                    ]
...
_s(ClaudeMdBuilderPage, "hr/ieuOAHv8Z9fDeMvqNBK72PXI=");
_c1 = ClaudeMdBuilderPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "Checkbox");
__turbopack_context__.k.register(_c1, "ClaudeMdBuilderPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_5df3ba93._.js.map